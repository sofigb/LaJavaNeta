...
public class Utility {
    ...
    public static String generateAlias() {
        ...
        String[] namesListThree = {"tongue", "search", "ill", "sleep", "gap", "dad", "shake", "feet", "life", "mouse", "mail", "idea", "rising", "oxygen", "forth", "two", "rail", "dug", "cat", "love", "bird", "call", "dollar", "slabs", "mark", "want", "pay", "farm", "strong", "knife", "jungle", "might", "thumb", "gain", "art", "tears", "place", "pack", "climate", "obtain", "look", "black", "lead", "travel", "slight", "threw", "castle", "strip", "ranch", "mirror", "glass", "act", "hat", "home", "charge", "model", "ear", "north", "ant", "swam", "touch", "eaten", "word", "heart", "fed", "receive", "wet", "equal", "age", "men", "grass", "eat", "prepare", "skill", "morning", "dawn", "sun", "dig", "voice", "rap", "solve", "combine", "ever", "bed", "private", "phone", "road", "today"};

        return namesListOne[(int) (Math.random() * namesListOne.length)] + "." + namesListTwo[(int) (Math.random() * namesListTwo.length)] + "." + namesListThree[(int) (Math.random() * namesListThree.length)];
    }
